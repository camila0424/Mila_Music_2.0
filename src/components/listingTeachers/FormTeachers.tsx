...
const FormTeachersList: React.FC<FormTeachersListProps> = ({
    ...
    <form className="flex flex-row md:flex-row gap-4 items-center bg-white text-fuchsia-800 shadow-md p-4 rounded-2xl mt-18 sticky top-21 z-50">
        ...
        <select
            ...
            className="w-full p-3 border rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none appearance-none"
        >
