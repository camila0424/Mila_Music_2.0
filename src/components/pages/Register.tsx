    ...
    return (
        <section className="flex justify-center items-center min-h-screen bg-fuchsia-100 px-4 pt-22 pb-7">
            ...
            >
                ...
                <button
                    type="submit"
                    className="w-full bg-fuchsia-800 text-white py-3 rounded-lg shadow hover:bg-fuchsia-700 transition font-semibold"
                >
                    Registrarme
                </button>
                ...
                <p className="text-center text-sm text-gray-600">
                    ¿Ya tienes cuenta?{" "}
                    <Link to="/login" className="text-fuchsia-800 font-semibold">
                        Inicia sesión
                    </Link>
                </p>
            </form>
