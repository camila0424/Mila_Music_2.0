    ...
    if (!teacherToShow) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
                ...
                <Link to="/" className="mt-4 px-4 py-2 bg-fuchsia-800 text-white rounded-lg shadow hover:bg-indigo-700 transition">
                    Volver
                </Link>
            </div>
        );
        ...
        <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-2xl py-20 px-6 space-y-6">
            <div className="flex flex-col md:flex-row gap-6 items-center">
                ...
                <div className="flex-1 space-y-2 text-center md:text-left">
                    <h3 className="text-2xl font-bold text-fuchsia-800">{teacherToShow.name}</h3>
                    ...
                    <p className="text-fuchsia-600 font-semibold">Valor de la clase: {teacherToShow.cost_per_hour}€</p>
                </div>
            </div>

            <div>
                <h3 className="text-xl font-semibold text-fuchsia-800">Título del anuncio</h3>
                <p className="text-gray-700">{teacherToShow.ad_title}</p>
            </div>

            <div>
                <h3 className="text-xl font-semibold text-fuchsia-800">Acerca del profe</h3>
                <p className="text-gray-700">{teacherToShow.ad_desc}</p>
            </div>

            <div>
                <h3 className="text-xl font-semibold text-fuchsia-800">Acerca de la clase</h3>
            ...
            <div className="flex justify-between pt-4">
                ...
                <Link to={`/contact-teacher/${teacherToShow.id}/${teacherToShow.name.replaceAll(/[\W_]+/g, "-")}`} className="px-4 py-2 bg-fuchsia-800 text-white rounded-lg shadow hover:bg-fuchsia-700 transition">Contactar</Link>
            </div>
        </div>
    );
};
